...
<head>
    ...
    <title>Verification Successfull | Faithly</title>
</head>

<body class="2xl:h-full">
<div
    class="bg-primary relative h-full 2xl:py-10 py-5 pb-16 flex flex-col justify-center items-center"
>
    <!-- TOP BAR -->
    <div
    ...
    <div class="container z-20 max-h-[900px] pb-2 mt-10">
        ...
        >
            <!-- Login Verification -->
            <div
                class="w-full h-auto Signup-screen transition-all flex items-stretch"
            >
                <!-- LEFT COLUMN -->
                <div
                    class="w-full md:w-6/12 lg:w-5/12 bg-white h-auto px-10 pb-10 pt-7 flex flex-col justify-center items-center"
                >
                    <img src="assets/images/verify-icon.png" alt="" />
                    <h2 class="text-lg font-bold text-[#374151]">
                ...
                <!-- RIGHT COLUMN -->
                <div
                    class="md:w-6/12 lg:w-7/12 py-5 bg-secondary h-full md:flex hidden justify-center items-center"
                >
                    <img
                        class="w-full p-6 max-w-[500px] fade-in-left-right"
