...
<div class="w-full lg:pl-[7.75rem]">
    ...
    <div class="container-main pb-14">
        <div
          class="shadow-[0px_4px_15px_rgba(9,67,111,0.15)] rounded-xl mt-20 p-5 py-14 flex flex-col items-center space-y-5"
        >
          <div
            class="inline-flex cursor-pointer w-full max-w-[375px] 2xl:max-w-[430px] justify-between bg-[#f4f3fc] rounded py-4 px-3 sm:px-5"
          >
            <div class="flex items-center gap-2">
              ...
              <div>
                ...
                <p class="text-[#777777]">Lorem lorem lorem</p>
              </div>
            </div>
            <p class="medium">9:56 AM</p>
          </div>
          <div
            class="inline-flex cursor-pointer w-full max-w-[375px] 2xl:max-w-[430px] justify-between rounded py-4 px-3 sm:px-5"
          >
            <div class="flex items-center gap-2">
              <span>
                <svg
